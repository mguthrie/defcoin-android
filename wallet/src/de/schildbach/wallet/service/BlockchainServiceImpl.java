...
import org.defcoin.DefcoinPeerDBDiscovery;
		...
		private void check()
		{
			...
			if (hasEverything && peerGroup == null)
			{
				...
				peerGroup.addPeerDiscovery(new PeerDiscovery()
				{
					...
					{
                        try {
                            dbPeerDiscovery = new DefcoinPeerDBDiscovery(Constants.NETWORK_PARAMETERS,
                                    getFileStreamPath("defcoin.peerdb"), peerGroup);
