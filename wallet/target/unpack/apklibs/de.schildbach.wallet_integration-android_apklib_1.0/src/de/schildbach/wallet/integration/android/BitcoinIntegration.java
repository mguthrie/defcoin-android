...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("defcoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No Defcoin application found.\nPlease install Defcoin Wallet.", Toast.LENGTH_LONG).show();
